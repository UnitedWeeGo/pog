...
<p>Put simply, whenever you're programming with PHP and a database, POG will help accelerate your development. POG generates PHP classes which map to tables in your database. The database used can be any one of the following: MySQL, Firebird, SQL Server, SQLite, PostgreSQL.</p>
