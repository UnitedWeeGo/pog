...
class Object
{
	...
	{
		$this->string .= "//\tPOG 1.0 rev19 (http://www.phpobjectgenerator.com)\n"; 
		$this->string .= "//\tFeel free to use the code for personal & commercial purposes. (Offered under the BSD license)\n\n"; 
